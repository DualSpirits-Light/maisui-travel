...
final class QuickPlanner {
 ...
 private String departure="",companions="",vehicleNumber="",accommodation="",accommodationAddress="",accommodationSourceUrl="",accommodationSnapshot="";
 ...
 private void capture(boolean strict){
  ...
  }else if(step==1){days=a.number(daysField,1,60);budget=Trip.cents(budgetField.getText().toString());daysDraft=String.valueOf(days);budgetDraft=Trip.money(budget);String enteredAccommodation=clip(accommodationField,120),enteredUrl=clip(accommodationLinkField,1000);if(!enteredUrl.equals(accommodationSourceUrl)){accommodationSnapshot="";}accommodation=enteredAccommodation;accommodationSourceUrl=enteredUrl;
 ...
 private void captureDraft(){
  ...
  else if(step==1){daysDraft=daysField.getText().toString().trim();budgetDraft=budgetField.getText().toString().trim();String enteredAccommodation=accommodationField.getText().toString().trim(),enteredUrl=accommodationLinkField.getText().toString().trim();if(!enteredUrl.equals(accommodationSourceUrl)){accommodationSnapshot="";}accommodation=enteredAccommodation;accommodationSourceUrl=enteredUrl;}

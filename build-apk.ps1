...
Run-Tool "$bt\aapt2.exe" @('link','-o',"$BuildDirectory\unsigned.apk",'-I',$platform,'--manifest',"$BuildDirectory\AndroidManifest.xml",'--java',"$BuildDirectory\generated",'--min-sdk-version','26','--target-sdk-version','35','--version-code','3','--version-name','0.2.0','-A',"$PSScriptRoot\app\src\main\assets", "$BuildDirectory\resources.zip")

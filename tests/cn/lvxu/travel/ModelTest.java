...
public final class ModelTest {
    ...
    public static void main(String[] args)throws Exception {
        ...
        t.departure="兰州";t.companions="小麦、小穗";t.vehicleNumber="CA1234";t.accommodation="湖畔客栈";t.accommodationAddress="湖滨路 1 号";t.accommodationSourceUrl="https://surl.amap.com/example";t.transportMode="骑行";copy=Trip.from(t.json());check(copy.departure.equals(t.departure)&&copy.companions.equals(t.companions)&&copy.vehicleNumber.equals(t.vehicleNumber)&&copy.accommodation.equals(t.accommodation)&&copy.accommodationAddress.equals(t.accommodationAddress)&&copy.accommodationSourceUrl.equals(t.accommodationSourceUrl)&&copy.transportMode.equals("骑行"),"optional travel details retained");
        JSONObject oldTrip=t.json();for(String key:new String[]{"departure","companions","vehicleNumber","accommodation","accommodationAddress","accommodationSourceUrl","transportMode"})oldTrip.remove(key);copy=Trip.from(oldTrip);check(copy.departure.isEmpty()&&copy.accommodation.isEmpty()&&copy.transportMode.equals("步行"),"legacy trip detail defaults");
